...
Prerequisites: Astronomer CLI, Snowflake account with TPC-H sample data
Configure: Add Snowflake connection (snowflake_conn) in Airflow UI
Deploy: astro dev start for local development
Run: DAG executes daily automatically or trigger manually
